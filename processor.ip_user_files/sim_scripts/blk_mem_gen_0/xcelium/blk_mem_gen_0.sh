...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_10 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_10 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_10 $xmvlog_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vishnu/processor/processor.cache/compile_simlib/xcelium"
  fi
