...
design_libs=(xpm blk_mem_gen_v8_4_10 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_10 $vlogan_opts +v2k \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vishnu/processor/processor.cache/compile_simlib/vcs"
  fi
